      ...
      <div className="w-full px-6 md:px-8 lg:px-12 xl:px-20 mx-auto max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col order-1 lg:order-1">
            ...
            {/* Tab titles — fixed height, no expanding content */}
              ...
              {SERVICES.map((service, index) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "group relative flex items-center gap-4 py-5 md:py-6 text-left transition-all duration-500 border-t border-border/50 first:border-0",
                      isActive
                        ? "text-foreground"
                  ...
                  >
                    ...
                    <span className="text-[9px] md:text-[10px] font-medium tabular-nums opacity-50 shrink-0">
                      /{service.id}
                    </span>
                    <span
                      className={cn(
            ...
            {/* Description area — fixed height, only content fades */}
            <div className="mt-6 h-20 relative overflow-hidden">
              <AnimatePresence mode="wait">
                <motion.p
                  ...
                  className="text-muted-foreground text-sm md:text-base font-normal leading-relaxed max-w-sm absolute inset-0"
                >
