...
const AboutSection = lazy(() => import("@/components/ui/about-section"));
const FeatureCarousel = lazy(() =>
  import("@/components/ui/feature-carousel").then((m) => ({ default: m.FeatureCarousel }))
);
const ElegantCarousel = lazy(() => import("@/components/ui/elegant-carousel"));
const TechMarquee = lazy(() => import("@/components/ui/tech-marquee"));
const Footer = lazy(() =>
  import("@/components/ui/footer-section").then((m) => ({ default: m.Footer }))
);
const Radar = lazy(() =>
  import("@/components/ui/radar-effect").then((m) => ({ default: m.Radar }))
);
const IconContainer = lazy(() =>
  import("@/components/ui/radar-effect").then((m) => ({ default: m.IconContainer }))
);
const FeatureSections = lazy(() => import("@/components/ui/feature-sections"));
const Cta4 = lazy(() =>
  import("@/components/ui/cta-4").then((m) => ({ default: m.Cta4 }))
);
const CtaCard = lazy(() =>
  import("@/components/ui/cta-card").then((m) => ({ default: m.CtaCard }))
);
const CtaEmailCard = lazy(() =>
  import("@/components/ui/call-to-action-cta").then((m) => ({ default: m.CtaEmailCard }))
);
